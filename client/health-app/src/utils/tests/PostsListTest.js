...
import { FlatList , PostCard , Button , Card } from "../Library" ;

const PostsListTest = (  ) => {

    let posts = [
        new Post( 'Gato en el jardín' , 'Un gato disfrutando de la naturaleza.' , 
            ...
            Math.random()<0.4 ) ,
        new Post( 'Gato juguetón' , 'Un gato jugando con una pelota de lana.' , 
            ...
            Math.random()<0.4 ) ,
        new Post( 'Gato durmiendo' , 'Un gato durmiendo plácidamente en su cama.' , 
            ...
            Math.random()<0.4 ) ,
        new Post( 'Gato comiendo' , 'Un gato disfrutando de su comida favorita.' , 
            ...
            Math.random()<0.4 ) ,
        new Post( 'Gato curioso' , 'Un gato explorando su entorno.' , 
            ...
            Math.random()<0.4 ) ,
        new Post( 'Gato feliz' , 'Un gato ronroneando de felicidad.' , 
            ...
            Math.random()<0.4 ) ,
        new Post( 'Gato sorprendido' , 'Un gato sorprendido por un ruido.' , 
            ...
            Math.random()<0.4 ) ,
        new Post( 'Gato en la ventana' , 'Un gato mirando por la ventana.' , 
            ...
            Math.random()<0.4 ) ,
        new Post( 'Gato y su juguete' , 'Un gato jugando con su juguete favorito.' , 
            ...
            Math.random()<0.4 ) ,
        new Post( 'Gato elegante' , 'Un gato mostrando su elegancia.' , 
